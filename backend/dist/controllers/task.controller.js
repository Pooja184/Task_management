...
exports.getOverdueTasks = exports.getAssignedToMeTasks = exports.updateTaskStatus = exports.deleteTask = exports.updateTask = exports.getMyTasks = exports.getTasks = exports.createTask = void 0;
...
const deleteTask = async (req, res) => {
    try {
        ...
        //  Emit socket event
        (0, socket_1.getIO)().emit("task-deleted", id);
        return res.status(200).json({
            success: true,
...
const updateTaskStatus = async (req, res) => {
    try {
        ...
        (0, socket_1.getIO)().emit("task-status-updated", {
            taskId,
            status,
        });
        return res.status(200).json({
